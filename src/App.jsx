      ...
      <div className="max-w-4xl my-10 mx-auto py-4 px-7 flex flex-col">
        <div className="flex flex-col sm:flex-row justify-center sm:justify-between sm:items-center gap-3">
          ...
          <div className="">
            ...
            <TypingAnimation
              words={["UI/UX Designer", "Full Stack Developer", "Freelancer"]}
              blinkCursor={true}
              pauseDelay={2000}
              loop
            ...
            <div className="flex w-60 my-5 items-center justify-start gap-4">
              ...
              <a target="blank" href="tel:+919044606415">
                <img
                  src="https://img.icons8.com/?size=100&id=WV326xpsBMyb&format=png&color=000000"
                  alt=""
                  className="h-6"
                />
              </a>

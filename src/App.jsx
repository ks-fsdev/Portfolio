        ...
        <>
          ...
          <div className="max-w-4xl my-10 mx-auto py-4 px-7 flex flex-col">
            ...
            <p className="my-4 text-sm sm:text-medium font-medium">
              Master of React, Tailwind CSS, and pixel-perfect UIs that
              captivate users. From Kanpur, I transform complex challenges into
              responsive, animated web experiences using Node.js, Firebase, and
              modern stacks. Passionate about clean code and innovation, ready
              to elevate your team. <br />
              <br /> In late 2024, I discovered a passion for web development.
              What started as a simple curiosity quickly became a deep dive down
              the rabbit hole of coding and building websites. Now, I’m fully
              immersed and excited to keep learning and growing in this field.
              Here are the skills I developed:
            </p>
            <MarqueeDemo />
          </div>
          <Separator></Separator>
